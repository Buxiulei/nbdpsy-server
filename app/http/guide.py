...
CHANGELOG_ENTRIES = [
    {
        ...
        "notes": "验收判据:已有 1 个话题的笔记补 4 个 → 结果 5 个、原话题保留(看 applied.topics "
                 ...
                 "topics_failed 给原因、其余不受连坐。**尚未跑过真号 e2e**(选择器复用发布链已"
                 "验证的正向判据,但补话题这条编辑链没实跑过):首批先跑 1-2 篇、到笔记里人工确认"
                 "话题真挂上再放量,别看到 applied.topics 缺词就反复重跑(每次重跑都是一次真提交)。"
                 "待补名单见需求文档(号 1/5/6/8 各 2 条),job278 那条已有 1 个按追加补齐其余 4 个。",
    },
    {
        "date": "2026-08-08",
