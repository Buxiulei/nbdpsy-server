...
from app.http import (
    ...
    interaction_coverage_rest,
    managed_accounts_rest,
    manifest,
    note_comment_rest,
    note_component_reads_rest,
    note_collection_batch_rest,
    note_collection_create_rest,
...
ALL_ROUTERS = [
    ...
    note_collection_batch_rest.router,
    note_collection_create_rest.router,
    note_extract_rest.router,
    interaction_backfill_rest.router,
    interaction_coverage_rest.router,
...
ALL_MANIFEST_ENTRIES = [
    ...
    *note_collection_batch_rest.MANIFEST_ENTRIES,
    *note_collection_create_rest.MANIFEST_ENTRIES,
    *note_extract_rest.MANIFEST_ENTRIES,
    *interaction_backfill_rest.MANIFEST_ENTRIES,
    *interaction_coverage_rest.MANIFEST_ENTRIES,
