...
class Settings(BaseSettings):
    ...
    # 「小助手联系方式」那篇笔记的平台 id:一篇笔记**本身就是咨询师推介笔记**时引用它。
    # 做成配置项而非写死在业务逻辑里 —— 这篇笔记以后可能被替换或重发,换一篇只改配置。
    # 置空 = 关掉这条规则(推介笔记就不引用任何笔记,留空而不是乱引一篇)。
    ASSISTANT_CONTACT_NOTE_ID: str = "6a6d5ba1000000002701c2ca"
